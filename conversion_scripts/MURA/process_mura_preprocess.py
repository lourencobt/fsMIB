...
def copy_full(dataframe, dst_path, counter):
    ...
    for idx in dataframe.index:
        counter += 1
        src_paths.append(dataframe[first_column][idx])
        dst_paths.append(os.path.join(dst_path, f"{counter}"+".png"))
    
    adjust_contrast(src_paths, dst_paths)
...
if __name__ == "__main__":
    process_mura("./MURA-v1.1", "./mura_processed")
